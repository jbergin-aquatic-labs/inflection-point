...
1. Build the VSIX project:
   ```
   dotnet build C:/Repos/VsDebugBridge/src/PrinciPal.Extension/PrinciPal.Extension.csproj -c Release
   ```

2. Report the build result. The output DLL is at:
   ```
   C:/Repos/VsDebugBridge/src/PrinciPal.Extension/bin/Release/net48/PrinciPal.Extension.dll
   ```
