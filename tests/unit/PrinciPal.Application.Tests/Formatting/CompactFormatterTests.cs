...
namespace PrinciPal.Application.Tests.Formatting;
...
public class CompactFormatterTests
{
    ...
    #region FormatCallStackFiltered
    ...
    #region FormatVariableChangeSummary
